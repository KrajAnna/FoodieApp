...
<%@ taglib prefix="c" uri="http://jakarta.apache.org/taglibs/jstl/core" %>
...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-6 bg-light p-4 rounded shadow-sm">
            <h4 class="text-dark text-center">Check your reviews</h4>
        </div>
    </div>
</div>
        ...
        <table class="table table-striped">
            ...
            <c:forEach items="${reviewRates}" var="reviewRate">
                <tr>
                    ...
                    <td><a class="btn btn-sm btn-primary" href="/reviews/${reviewRate.review.id}">Check details</a></td>
